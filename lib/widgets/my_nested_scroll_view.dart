...
/// {@end-tool}
///
/// ## [SliverAppBar]s with [MyNestedScrollView]s
///
/// Using a [SliverAppBar] in the outer scroll view, or [headerSliverBuilder],
/// of a [MyNestedScrollView] may require special configurations in order to work
/// as it would if the outer and inner were one single scroll view, like a
/// [CustomScrollView].
///
/// ### Pinned [SliverAppBar]s
///
/// A pinned [SliverAppBar] works in a [MyNestedScrollView] exactly as it would in
...
///
/// This works naturally in a [MyNestedScrollView], as the pinned [SliverAppBar]
...
///
/// In order to float the outer, use [MyNestedScrollView.floatHeaderSlivers]. When
...
/// {@tool sample --template=stateless_widget_material}
///
/// This simple example shows a [MyNestedScrollView] whose header contains a
...
///
/// It is possible with a [MyNestedScrollView] to perform just the snapping
/// animation without floating the app bar in and out. By not using the
/// [MyNestedScrollView.floatHeaderSlivers], the app bar will snap in and out
/// without floating.
///
...
/// implemented in a [MyNestedScrollView]. These widgets take any overlapping
...
/// e.g [MyNestedScrollView.floatHeaderSlivers], the [SliverAppBar] will animate
...
/// Currently, [MyNestedScrollView] does not support simultaneously floating and
...
/// Currently, [MyNestedScrollView] does not support stretching the outer
...
/// The [State] for a [MyNestedScrollView].
///
/// The [ScrollController]s, [innerController] and [outerController], of the
/// [MyNestedScrollView]'s children may be accessed through its state. This is
/// useful for obtaining respective scroll positions in the [MyNestedScrollView].
///
/// If you want to access the inner or outer scroll controller of a
/// [MyNestedScrollView], you can get its [MyNestedScrollViewState] by supplying a
/// `GlobalKey<NestedScrollViewState>` to the [MyNestedScrollView.key] parameter).
///
/// {@tool dartpad --template=stateless_widget_material}
/// [MyNestedScrollViewState] can be obtained using a [GlobalKey].
...
/// and an [NestedScrollViewViewport], to shift overlap in a [MyNestedScrollView].
///
...
/// See also:
///
///  * [MyNestedScrollView], which uses a [NestedScrollViewViewport] and a
...
/// See also:
///
///  * [MyNestedScrollView], whose documentation has sample code showing how to
///    use this widget.
...
/// See also:
///
///  * [MyNestedScrollView], which uses a [SliverOverlapAbsorber] to align its
...
/// The [Viewport] variant used by [MyNestedScrollView].
///
...
/// The [RenderViewport] variant used by [MyNestedScrollView].
///
/// This viewport takes a [SliverOverlapAbsorberHandle] and notifies it any time
/// the viewport needs to recompute its layout (e.g. when it is scrolled).
