      ...
      builder: (controller) => DefaultTabController(
          ...
          child: NestedScrollView(
            ...
            headerSliverBuilder:
              ...
              controller.setTabController(context);
              return <Widget>[
                SliverAppBar(
                  flexibleSpace: Column(
                    mainAxisAlignment: MainAxisAlignment.end,
                    children: [
                      Obx(() => TradeDurationGroup(
                            onPressed: (durationIndex) {
                              controller.setDurationIndex(durationIndex);
                            },
                            selectedIndex: controller.getSelectedIndex(),
                            durations:
                                (controller.selectedIndicator.durationsInMin)!
                                    .cast<int>(),
                          ))
                    ],
                  ),
                ...
                if(controller.followedMarkets.value!.length > 0)
                  ...
                  sliver: SliverAppBar(
                    ...
                    pinned: true,
                    bottom: MyTabBar(
                      tabs: controller.indicators!.map((i) => i.name!).toList(),
            ...
            body: controller.followedMarkets.value!.length > 0
                ? Obx(() => SignalsTabBarView(
